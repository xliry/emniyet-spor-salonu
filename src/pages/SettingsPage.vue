...
async function changePassword(){
  passwordError.value=''
  if(newPassword.value.length<12){passwordError.value='Yeni şifre en az 12 karakter olmalı.';return}
