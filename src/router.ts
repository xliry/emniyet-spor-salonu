...
const routes = [
  { path: '/login', name: 'login', component: () => import('@/pages/LoginPage.vue'), meta: { public: true } },
  {
    path: '/', component: AppShell, children: [
      ...
      { path: 'membership-plans', redirect: '/settings/membership-plans' },
      ...
      { path: 'settings/membership-plans', name: 'membership-plans', component: () => import('@/pages/MembershipPlanSettingsPage.vue'), meta: { roles: ['owner', 'manager'] } },
    ],
  },
